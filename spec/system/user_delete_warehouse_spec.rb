...
describe 'Usuário remove um galpão' do
  ...
  it 'e não apaga outros galpões' do
    warehouse_1 = Warehouse.create!(name: 'Sampa', code: 'SPY', city: 'São Paulo', area: '30_000',
    address: 'Rua do galpão SP, 1213', zip: 4235342523, description: 'Descricao galpao SP')
    warehouse_2 = Warehouse.create!(name: 'Rio', code: 'SDU', city: 'Rio de Janeiro', area: '50_000',
